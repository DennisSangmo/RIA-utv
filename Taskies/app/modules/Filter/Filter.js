...
Taskies.app.modules.Filter.prototype.init = function() {
	...
	goog.events.listen(this.view.elements.search, 'focus', function(e){
...
Taskies.app.modules.Filter.prototype.view = {
	...
	draw: function(myElement){
		...
		"<p><input type='button' value='Apply' id='" + this.elements.submit + "' /></p>"+
		"</div><div id='filter-create-wrapper'><div id='" + this.elements.create + "' class='pointerCurser'><h4>Create a new Taskie!</h4></div></div></div>";
